...
from src.criteria.face_parsing.model_utils import *
from src.models.encoders.helpers import l2_norm
...
class unet(nn.Module):
    ...
    def extract_feats(self, inputs):
        ...
        return [l2_norm(conv1.view(bs, -1)),  # 512
                l2_norm(conv2.view(bs, -1)),  # 256
                l2_norm(conv3.view(bs, -1)),  # 128
                l2_norm(conv4.view(bs, -1)),  # 64
                l2_norm(center.view(bs, -1))] # 32