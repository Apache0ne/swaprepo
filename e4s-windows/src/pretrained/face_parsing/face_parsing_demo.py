...
def is_segnext_available():
    try:
        from mmseg.apis import init_segmentor, inference_segmentor  # noqa: F401
        return True
    except Exception:
        return False
    ...
    if faceParser_name == "default":
        ...
        try:
            ...
            raise ModuleNotFoundError(
                "SegNeXt requires the old MMSegmentation stack. "
                "Install a compatible mmseg/mmcv/mmcls environment first, "
                "or switch the face parser back to 'default'."
            ) from exc
